...
class Api extends MX_Controller
{
    ...
    public function addAppointment()
    {
        ...
        $patient_phone = $this->api_model->getPatientByIdMM($patient)->phone;
        $add_date = date('m/d/y');
        $registration_time = time();
        $temp_phone = str_replace('+', '', $patient_phone);
        ...
        $patient_details = $this->api_model->getPatientByIdMM($patient);
        $patientname = $this->api_model->getPatientByIdMM($patient)->name;
        $doctorname = $this->api_model->getDoctorById($doctor, $this->hospitalID)->name;
        $data = array();
        $data = array(
            'patient' => $patient,
