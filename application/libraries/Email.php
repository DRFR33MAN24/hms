...
class CI_Email
{
	...
	var	$smtp_host		= "smtp.hostinger.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "mahmudesseyho@gmail.com";		// SMTP Username
	var	$smtp_pass		= "Shbabalbnaa.7";		// SMTP Password
